/*ddos2dfs.c: Splitst DDOS diskdumps in aparte DFS diskbeelden
...
#else
  #define fout byte=ddos_no+65; printf("Unexpected end of DDOS diskimage" \
...
void ddos2dfs(int argc, char *argv[], int options) {
  FILE *fpdfs, *fpdisk;
  char  dfs_image[50], disk[50], basisnaam[50];
